...
exports.parse = function(filenames, options)
{
    ...
    var jsonspaces = options.minify ? null : 2;

    if (options.outfile) {
      jsonfile.writeFileSync(options.outfile, parse_all_the_files, {spaces: jsonspaces});
    } else {
      return JSON.stringify(parse_all_the_files, null, jsonspaces);
    }
};
})();
